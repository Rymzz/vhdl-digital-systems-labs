...
#     [get_ports { I_sw_top }]; #IO_L7N_T1_AD2N_35 Sch=sw[0]
# set_property \
...
set_property \
    ...
    [get_ports { O_rgbleds_top[0] }]; #IO_L22N_T3_AD7N_35 Sch=led4_b
set_property \
    -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } \
    [get_ports { O_rgbleds_top[1] }]; #IO_L16P_T2_35 Sch=led4_g
set_property \
    -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } \
    [get_ports { O_rgbleds_top[2] }]; #IO_L21P_T3_DQS_AD14P_35 Sch=led4_r
set_property \
    -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } \
    [get_ports { O_rgbleds_top[3] }]; #IO_0_35 Sch=led5_b
set_property \
    -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } \
    [get_ports { O_rgbleds_top[4] }]; #IO_L22P_T3_AD7P_35 Sch=led5_g
set_property \
    -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } \
    [get_ports { O_rgbleds_top[5] }]; #IO_L23N_T3_35 Sch=led5_r
